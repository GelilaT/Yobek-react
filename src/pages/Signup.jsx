      ...
      shadow-lg backdrop-filter backdrop-blur-lg bg-opacity-30 relative'>
        ...
        <form onSubmit={handleSubmit}>
          <div className='relative my-4'>
              ...
              <label htmlFor="name" className={`absolute text-sm duration-300 transform -translate scale-75 top-3 -z-10 origin-[0] 
          ...
          hover:text-blue-400 transition-colors duration-300'>Sign up</button>
        </form>
        <p className='text-center'>Already have an account? <Link to='/login' className='text-white'>Log in</Link></p>
      </div>
    </div>
  )
}
